...
drop procedure dbo.usp_CBI_RevenueToSeptemberBI_From20170522
go

-- =============================================
-- Author:		<Terje Golden Sæther - Visma Retail AS>
-- CreatedDate: 24.06.2017
-- Last ModifiedDate: 24.06.2017
-- This Stored Procedure is a modified version of the usp_CBI_RevenueToSeptemberBI
-- It retreives data from 22.05.2017 up to current day
-- How to use:  
...
--		Output:
--		A semicolon separated file name similar to <13.06.2017-VITA_KontrolltallSeptemberBI_From22.05.2017.csv>
-- =============================================

create procedure dbo.usp_CBI_RevenueToSeptemberBI_From20170522
as
begin
	...
	-- config start	
	set @RunDate 			= convert(date,'22.05.2017',104)
	set @ExportFileName		= convert(varchar(10),getdate(),104) + '-'+'VITA_KontrolltallSeptemberBI_From22.05.2017.csv'
