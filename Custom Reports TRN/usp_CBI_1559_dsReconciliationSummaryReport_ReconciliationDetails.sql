...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_CBI_1559_dsReconciliationSummaryReport_ReconciliationDetails]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_CBI_1559_dsReconciliationSummaryReport_ReconciliationDetails]
GO
...
-- =============================================
CREATE  PROCEDURE [dbo].[usp_CBI_1559_dsReconciliationSummaryReport_ReconciliationDetails]     
(
@TotalTypeId AS INT ,	
	---------------------------------------------
