...
/****** Object:  StoredProcedure [dbo].[usp_CBI_AccountExport_ToFile]    Script Date: 18.02.2020 13.24.26 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SET @PasswordBCPCommand = '5aIqQz53'
	SET @BCPCommands = '-c -CACP -t -S'
	SET @ExportPath = '\\N13OS2SUT275T\104610Data$\AX\AX.Settle.V1\'
	--AX.Test.AM
	--SET @ExportPath = '\\N13OS2SUT275T\104610Data$\AX\AX.Test.AM\'
	--SET @ExportPath = 'C:\temp\AccDebug\'
	SET @ExportFileName = 'Accounting'
	SET @PrintExportFileContentToScreen = 1
	SET @Guid = NEWID()	
