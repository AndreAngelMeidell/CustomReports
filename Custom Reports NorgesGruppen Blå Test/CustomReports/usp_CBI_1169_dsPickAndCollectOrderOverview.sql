...
/****** Object:  StoredProcedure [dbo].[usp_CBI_1169_dsPickAndCollectOrderOverview]    Script Date: 25.09.2020 12:13:00 ******/
SET ANSI_NULLS ON
GO
...
WHERE 
	...
	and SubstitutionForEan is null
	and IsHiddenFromPickList=0
GROUP BY
