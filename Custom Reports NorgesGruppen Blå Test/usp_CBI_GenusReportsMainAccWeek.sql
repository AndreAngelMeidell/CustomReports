...
/****** Object:  StoredProcedure [dbo].[usp_CBI_GenusReportsMainAccWeek]    Script Date: 10.02.2021 09:57:28 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	-- Endring 20200129 Sets First day of week to Monday
	-- Endring 20210210 Week til iso_week
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT @count = COUNT(*)  FROM BI_Mart.RBIM.Agg_SalesAndReturnPerDay sales
                ...
                WHERE tdate.WeekNumberOfYear = DATEPART(ISO_WEEK,@InParamReportDate) AND tdate.Year = DATEPART(YEAR,@InParamReportDate) AND tdate.FullDate IS NOT NULL
