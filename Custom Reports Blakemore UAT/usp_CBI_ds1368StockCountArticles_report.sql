...
/****** Object:  StoredProcedure [dbo].[usp_CBI_ds1368StockCountArticles_report]    Script Date: 12.11.2020 13:02:39 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	(
		...
		LEFT JOIN dbo.SupplierArticles AS sa ON sa.ArticleNo = sscl.ArticleNo AND PrimarySupplierArticle=1
		LEFT JOIN ActivePurchasePrices AAP ON AAP.ArticleNo = sscl.ArticleNo AND AAP.StoreNo = sscl.StoreNo  AND AAP.SupplierArticleId = sa.SupplierArticleID 
