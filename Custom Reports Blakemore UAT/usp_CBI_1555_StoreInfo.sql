...
/****** Object:  StoredProcedure [dbo].[usp_CBI_1555_StoreInfo]    Script Date: 13.11.2020 08:42:49 ******/
DROP PROCEDURE [dbo].[usp_CBI_1555_StoreInfo]
GO
...
INTO #StoreFormat
FROM [AFBS-VRSSQL-CORE01].RSCompanyAdminESDb.dbo.Stores AS S 
JOIN [AFBS-VRSSQL-CORE01].RSCompanyAdminESDb.dbo.StoreGroupLinks AS SGL ON SGL.StoreNo = S.StoreNo
JOIN [AFBS-VRSSQL-CORE01].RSCompanyAdminESDb.dbo.StoreGroups AS SG ON SG.StoreGroupNo = SGL.StoreGroupNo AND SG.StoreGroupTypeNo = 14
WHERE 1=1
--AND s.StoreID=14777 
