...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.usp_CBI_1180_dsDailySalesReport_topArticles') AND type in (N'P', N'PC'))
	DROP PROCEDURE dbo.usp_CBI_1180_dsDailySalesReport_topArticles
GO
...
CREATE PROCEDURE dbo.usp_CBI_1180_dsDailySalesReport_topArticles
(	 
