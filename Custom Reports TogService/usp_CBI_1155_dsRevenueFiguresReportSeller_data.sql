...
if (object_id('dbo.usp_CBI_1155_dsRevenueFiguresReportSeller_data') is not null)
	drop procedure dbo.usp_CBI_1155_dsRevenueFiguresReportSeller_data
go
...
CREATE PROCEDURE dbo.usp_CBI_1155_dsRevenueFiguresReportSeller_data
(   
...
---------------------------------------------------------
	...
	SELECT 
		...
		,SUM(SalesRevenueInclVat)		'SalesRevenueInclVat'	-- RS-26947
		,SUM(SalesRevenue)				'SalesRevenue'			-- RS-26947
		,SUM(GrossProfit)				'GrossProfit' 
		,SUM(Price)						'Price'
		,SUM(CostOfGoods)				'CostOfGoods'			-- RS-26947 RS-27090
