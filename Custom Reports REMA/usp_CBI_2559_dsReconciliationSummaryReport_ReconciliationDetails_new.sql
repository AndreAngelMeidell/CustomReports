...
/****** Object:  StoredProcedure [dbo].[usp_CBI_2559_dsReconciliationSummaryReport_ReconciliationDetails_new]    Script Date: 07.02.2020 10:34:09 ******/
SET ANSI_NULLS ON
GO
...
CREATE  PROCEDURE [dbo].[usp_CBI_2559_dsReconciliationSummaryReport_ReconciliationDetails_new]     
(
@TotalTypeId AS INT ,	
---------------------------------------------
...
--20191219 Endrer til Agg_ReceiptTenderDaily
...
SET @TotalTypeId = 2 --RS-45270
	...
	ELSE BEGIN	
		...
		--	FROM RBIM.Agg_ReceiptTenderDaily f (NOLOCK)
		--	INNER JOIN #TenderSelection dt ON dt.TenderIdx = f.TenderIdx
		...
		--	--AND f.ReceiptStatusIdx = 1	--Is missing in agg table		
		--	GROUP BY f.StoreIdx	
