...
/****** Object:  StoredProcedure [dbo].[usp_CBI_1135_dsArticleSalesAndRevenueReport_data]    Script Date: 15.01.2019 09:10:36 ******/
SET ANSI_NULLS ON
GO
...
FROM BI_Mart.RBIM.Agg_SalesAndReturnPerDay (NOLOCK)f 
JOIN rbim.Dim_Date (NOLOCK) dd ON dd.DateIdx = f.ReceiptDateIdx 
JOIN rbim.Dim_Article (NOLOCK) da ON da.ArticleIdx = f.ArticleIdx 
