...
/****** Object:  StoredProcedure [dbo].[usp_CBI_ds1300_ArticlesDetail]    Script Date: 05.11.2020 11:36:00 ******/
DROP PROCEDURE [dbo].[usp_CBI_ds1300_ArticlesDetail]
GO
...
--20190508 Endret til: LEFT JOIN [NGVRSDBCIM01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo

-- 20201105 LEFT JOIN [NGVRSDBCIM01P].RSItemESDb.dbo.Articles AS Item ON Item.ArticleID = a.ArticleID
-- 20201105 LEFT JOIN [NGVRSDBCIM01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo
-- til:
-- 20201105 LEFT JOIN [NGVRSDBITEM01P].RSItemESDb.dbo.Articles AS Item ON Item.ArticleID = a.ArticleID
-- 20201105 LEFT JOIN [NGVRSDBITEM01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo
...
FROM StoreStockCountLines sscl
	...
	LEFT JOIN [NGVRSDBITEM01P].RSItemESDb.dbo.Articles AS Item ON Item.ArticleID = a.ArticleID
	LEFT JOIN [NGVRSDBITEM01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo
	WHERE 1=1
