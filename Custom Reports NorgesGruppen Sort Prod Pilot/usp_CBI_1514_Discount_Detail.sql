...
/****** Object:  StoredProcedure [dbo].[usp_CBI_1514_Discount_Detail]    Script Date: 15.04.2021 13:55:03 ******/
SET ANSI_NULLS ON
GO
...
,SUM(DiscountAmount)/sum(ISNULL(NULLIF(SalesPrice,0),1))*100 AS TotalDiscountPRC
