...
/****** Object:  StoredProcedure [dbo].[usp_CBI_ds1358StockCountArticlesNotCounted_report]    Script Date: 23.02.2021 12:20:36 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	FROM Articles ar
			...
			JOIN dbo.StockAdjustments AS Sold ON Sold.StoreNo = saa.StoreNo AND Sold.ArticleNo = ar.ArticleNo AND Sold.ArticleNo = saa.ArticleNo AND Sold.AdjustmentDate BETWEEN @FromDate AND @ToDate AND sold.StockAdjType=1
