...
/****** Object:  StoredProcedure [dbo].[usp_CBI_ds1300_ArticlesDetail]    Script Date: 30.10.2019 13:12:48 ******/
SET ANSI_NULLS ON
GO
...
--20190508 Endret til: LEFT JOIN [NGVRSDBITMST01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo
SET NOCOUNT ON 
...
FROM StoreStockCountLines sscl
	...
	LEFT JOIN [NGVRSDBITMST01P].RSItemESDb.dbo.Articles AS Item ON Item.ArticleID = a.ArticleID
	LEFT JOIN [NGVRSDBITMST01P].RSItemESDb.dbo.SalesUnitTypes AS SUT ON SUT.SalesUnitTypeNo = Item.SalesUnitTypeNo
	WHERE 1=1
