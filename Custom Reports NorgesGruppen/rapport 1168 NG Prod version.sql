...
GO
/****** Object:  StoredProcedure [dbo].[usp_CBI_1168_dsPickAndCollectTimeUseReport_data]    Script Date: 15.09.2020 13.30.09 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_CBI_1168_dsPickAndCollectTimeUseReport_data](
@StoreId	INT
,@DateFrom	DATE
,@DateTo	DATE
)
