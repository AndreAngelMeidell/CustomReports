...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.usp_CBI_1155_dsRevenueFiguresSubReport_NG_data') AND type in (N'P', N'PC'))
	DROP PROCEDURE dbo.usp_CBI_1155_dsRevenueFiguresSubReport_NG_data
GO
